 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(t){return ht({...t,state:!0,attribute:!1})}function ut(t){if(!t||"None"===t||""===t.trim())return 0;const e=new Date(t.trim());return isNaN(e.getTime())?0:e.getTime()/1e3}function gt(t){if(!t)return{locale:void 0};const e=t.language;return"12"===t.time_format?{locale:e,hour12:!0}:"24"===t.time_format?{locale:e,hour12:!1}:{locale:e}}function ft(t,e){if(t<=0)return"N/A";const s=new Date(1e3*t),i=new Date,r=gt(e),o={hour:"2-digit",minute:"2-digit"};void 0!==r.hour12&&(o.hour12=r.hour12);const n=s.toLocaleTimeString(r.locale,o);return s.getFullYear()===i.getFullYear()&&s.getMonth()===i.getMonth()&&s.getDate()===i.getDate()?n:`${n} (${s.toLocaleDateString(r.locale)})`}function vt(t,e){if(t<=100)return"N/A";const s=gt(e),i={};return void 0!==s.hour12&&(i.hour12=s.hour12),new Date(1e3*t).toLocaleString(s.locale,i)}function mt(t){const e=t.split("/");return e[e.length-1].toUpperCase()}const $t=n`
...
`;let bt=class extends nt{setConfig(t){this._config=t}_fireConfigChanged(t){this._config=t;const e=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(e)}_entityChanged(t){const e=t.detail.value;e!==this._config.entity&&this._fireConfigChanged({...this._config,entity:e})}_titleChanged(t){const e=t.target.value;if(e===(this._config.title||""))return;const s={...this._config};e?s.title=e:delete s.title,this._fireConfigChanged(s)}_zonesChanged(t){const e=t.target.value,s={...this._config};e.trim()?s.zones=e.split(",").map(t=>t.trim()).filter(Boolean):delete s.zones,this._fireConfigChanged(s)}render(){if(!this.hass||!this._config)return B``;const t=this._config.zones?this._config.zones.join(", "):"";return B`
      <div class="editor">
        <ha-selector
          .hass=${this.hass}
  ...
  `,t([ht({attribute:!1})],bt.prototype,"hass",void 0),t([pt()],bt.prototype,"_config",void 0),bt=t([lt("nws-alerts-card-editor")],bt);let _t=class extends nt{constructor(){super(...arguments),this._expandedAlerts=new Map}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this._config=t}getCardSize(){const t=this._getAlerts();return Math.max(1,3*t.length)}static getConfigElement(){return document.createElement("nws-alerts-card-editor")}static getStubConfig(){return{entity:"sensor.nws_alerts_alerts"}}_getAlerts(){if(!this.hass||!this._config)return[];const t=this.hass.states[this._config.entity];if(!t)return[];const e=t.attributes.Alerts||[];if(this._config.zones&&this._config.zones.length>0){const t=new Set(this._config.zones.map(t=>t.toUpperCase()));return e.filter(e=>function(t,e){if(t.AffectedZones)for(const s of t.AffectedZones)if(e.has(mt(s)))return!0;if(t.Geocode?.UGC)for(const s of t.Geocode.UGC)if(e.has(s.toUpperCase()))return!0;return!1}(e,t))}return e}_toggleDetails(t){const e=new Map(this._expandedAlerts);e.set(t,!e.get(t)),this._expandedAlerts=e}render(){if(!this._config||!this.hass)return B``;if(!this.hass.states[this._config.entity])return B`
        <ha-card .header=${this._config.title||""}>
          <div class="error">
            Entity not found: ${this._config.entity}
          </div>
        </ha-card>
      `;const t=this._getAlerts();return B`
      <ha-card .header=${this._config.title||""}>
    ...
    `}_renderProgressSection(t,e){const{isActive:s,progressPct:i,hasEndTime:r,onsetMinutes:o,onsetHours:n,onsetTs:a,endsTs:l,nowTs:c}=e,d=s&&!r?"width: 100%; left: 0; animation: ongoing-pulse 5s infinite; opacity: 0.8;":`width: ${100-i}%; left: ${i}%;`;return B`
      <div class="progress-section">
        <div class="progress-labels">
          <div class="label-left">
            <span class="label-sub">${s?"Start":"Now"}</span><br>
            ${ft(s?a:c,this.hass.locale)}
          </div>
    ...
    `}};_t.styles=$t,t([ht({attribute:!1})],_t.prototype,"hass",void 0),t([pt()],_t.prototype,"_config",void 0),t([pt()],_t.prototype,"_expandedAlerts",void 0),_t=t([lt("nws-alerts-card")],_t);const yt=window;yt.customCards=yt.customCards||[],yt.customCards.push({type:"nws-alerts-card",name:"NWS Alerts Card",description:"A card for displaying NWS weather alerts with severity indicators, progress bars, and expandable details."});export{_t as NwsAlertsCard};
