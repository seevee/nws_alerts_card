 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ct=t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)},lt={attribute:!0,type:String,converter:_,reflect:!1,hasChanged:b},dt=(t=lt,e,i)=>{const{kind:s,metadata:r}=i;let o=globalThis.litPropertyMetadata.get(r);if(void 0===o&&globalThis.litPropertyMetadata.set(r,o=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),o.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let xt=class extends nt{setConfig(t){this._config=t}_fireConfigChanged(t){this._config=t;const e=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(e)}_entityChanged(t){const e=t.detail.value;e!==this._config.entity&&this._fireConfigChanged({...this._config,entity:e})}_titleChanged(t){const e=t.target.value;if(e===(this._config.title||""))return;const i={...this._config};e?i.title=e:delete i.title,this._fireConfigChanged(i)}_animationsChanged(t){const e=t.target.checked;if(e===(!1!==this._config.animations))return;const i={...this._config};e?delete i.animations:i.animations=!1,this._fireConfigChanged(i)}_layoutChanged(t){const e=t.target.checked;if(e===("compact"===this._config.layout))return;const i={...this._config};e?i.layout="compact":delete i.layout,this._fireConfigChanged(i)}_zonesChanged(t){const e=t.target.value,i={...this._config};e.trim()?i.zones=e.split(",").map(t=>t.trim()).filter(Boolean):delete i.zones,this._fireConfigChanged(i)}render(){if(!this.hass||!this._config)return B``;const t=this._config.zones?this._config.zones.join(", "):"";return B`
      <div class="editor">
        <ha-selector
          .hass=${this.hass}
  ...
  `,t([ht({attribute:!1})],xt.prototype,"hass",void 0),t([pt()],xt.prototype,"_config",void 0),xt=t([ct("nws-alerts-card-editor")],xt);let At=class extends nt{constructor(){super(...arguments),this._expandedAlerts=new Map}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this._config=t}getCardSize(){const t=this._getAlerts(),e="compact"===this._config?.layout?1:3;return Math.max(1,t.length*e)}static getConfigElement(){return document.createElement("nws-alerts-card-editor")}static getStubConfig(){return{entity:"sensor.nws_alerts_alerts"}}_getAlerts(){if(!this.hass||!this._config)return[];const t=this.hass.states[this._config.entity];if(!t)return[];const e=t.attributes.Alerts||[];if(this._config.zones&&this._config.zones.length>0){const t=new Set(this._config.zones.map(t=>t.toUpperCase()));return e.filter(e=>function(t,e){if(t.AffectedZones)for(const i of t.AffectedZones)if(e.has(bt(i)))return!0;if(t.Geocode?.UGC)for(const i of t.Geocode.UGC)if(e.has(i.toUpperCase()))return!0;return!1}(e,t))}return e}_toggleDetails(t){const e=new Map(this._expandedAlerts);e.set(t,!e.get(t)),this._expandedAlerts=e}render(){if(!this._config||!this.hass)return B``;if(!this.hass.states[this._config.entity])return B`
    ...
    `}_renderAlert(t){const e=function(t){const e=(t||"").toLowerCase().replace(/\s/g,"");return["extreme","severe","moderate","minor"].includes(e)?e:"unknown"}(t.Severity),i=`severity-${e}`,s=function(t){const e=Date.now()/1e3,i=ft(t.Sent),s=i>0?i:e;let r=ft(t.Onset);0===r&&(r=s);const o=r+3600;let n=ft(t.Ends||t.Expires||"");0===n&&(n=o);const a=!(!t.Ends&&!t.Expires),c=e>=r;let l,d,h,p;c?(l=r,d=n,h=e,p="Active"):(l=e,d=n,h=r,p="Preparation");const u=d-l,g=(h-l)/(u>0?u:1)*100;return{isActive:c,phaseText:p,progressPct:Math.max(0,Math.min(100,Math.round(10*g)/10)),remainingHours:Math.round((n-e)/3600*10)/10,onsetHours:Math.round((r-e)/3600*10)/10,onsetMinutes:Math.round((r-e)/60),onsetTs:r,endsTs:n,sentTs:i,nowTs:e,hasEndTime:a}}(t),r=s.phaseText.toLowerCase(),o=this._expandedAlerts.get(t.ID)||!1;return"compact"===this._config.layout?this._renderCompactAlert(t,i,r,s,o):this._renderFullAlert(t,i,r,s,o)}_renderCompactAlert(t,e,i,s,r){return B`
        ...
        <div class="alert-header-row">
          ...
          <div class="info-box">
            ...
            <div class="badges-row">
              ...
              ${s.isActive?B`<span class="badge active-badge">Active</span>`:B`<span class="badge prep-badge">In Prep</span>`}
            </div>
          </div>
        </div>
    ...
    `}_renderDetailsContent(t,e){const i=(t.Description||"").replace(/\n{2,}/g,"\n\n").trim(),s=(t.Instruction||"").replace(/\n{2,}/g,"\n\n").trim();return B`
    ...
    `}_renderProgressSection(t,e){const{isActive:i,progressPct:s,hasEndTime:r,onsetMinutes:o,onsetHours:n,onsetTs:a,endsTs:c,nowTs:l}=e,d=!1===this._config.animations,h=i&&!r?d?"width: 100%; left: 0; opacity: 0.8;":"width: 100%; left: 0; animation: ongoing-pulse 5s infinite; opacity: 0.8;":`width: ${100-s}%; left: ${s}%;`;return B`
      <div class="progress-section">
        <div class="progress-labels">
          <div class="label-left">
            <span class="label-sub">${i?"Start":"Now"}</span><br>
            ${$t(i?a:l,this.hass.locale)}
          </div>
