 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(t){return ht({...t,state:!0,attribute:!1})}function ut(t){if(!t||"None"===t||""===t.trim())return 0;const e=new Date(t.trim());return isNaN(e.getTime())?0:e.getTime()/1e3}function gt(t){if(t<=0)return"N/A";const e=new Date(1e3*t),s=new Date,i=e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return e.getFullYear()===s.getFullYear()&&e.getMonth()===s.getMonth()&&e.getDate()===s.getDate()?i:`${i} (${e.toLocaleDateString()})`}function ft(t){return t<=100?"N/A":new Date(1e3*t).toLocaleString()}function vt(t){const e=t.split("/");return e[e.length-1].toUpperCase()}const mt=n`
...
`;let $t=class extends nt{setConfig(t){this._config=t}_fireConfigChanged(t){this._config=t;const e=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(e)}_entityChanged(t){const e=t.detail.value;e!==this._config.entity&&this._fireConfigChanged({...this._config,entity:e})}_titleChanged(t){const e=t.target.value;if(e===(this._config.title||""))return;const s={...this._config};e?s.title=e:delete s.title,this._fireConfigChanged(s)}_zonesChanged(t){const e=t.target.value,s={...this._config};e.trim()?s.zones=e.split(",").map(t=>t.trim()).filter(Boolean):delete s.zones,this._fireConfigChanged(s)}render(){if(!this.hass||!this._config)return B``;const t=this._config.zones?this._config.zones.join(", "):"";return B`
  ...
  `,t([ht({attribute:!1})],$t.prototype,"hass",void 0),t([pt()],$t.prototype,"_config",void 0),$t=t([lt("nws-alerts-card-editor")],$t);let bt=class extends nt{constructor(){super(...arguments),this._expandedAlerts=new Map}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this._config=t}getCardSize(){const t=this._getAlerts();return Math.max(1,3*t.length)}static getConfigElement(){return document.createElement("nws-alerts-card-editor")}static getStubConfig(){return{entity:"sensor.nws_alerts_alerts"}}_getAlerts(){if(!this.hass||!this._config)return[];const t=this.hass.states[this._config.entity];if(!t)return[];const e=t.attributes.Alerts||[];if(this._config.zones&&this._config.zones.length>0){const t=new Set(this._config.zones.map(t=>t.toUpperCase()));return e.filter(e=>function(t,e){if(t.AffectedZones)for(const s of t.AffectedZones)if(e.has(vt(s)))return!0;if(t.Geocode?.UGC)for(const s of t.Geocode.UGC)if(e.has(s.toUpperCase()))return!0;return!1}(e,t))}return e}_toggleDetails(t){const e=new Map(this._expandedAlerts);e.set(t,!e.get(t)),this._expandedAlerts=e}render(){if(!this._config||!this.hass)return B``;if(!this.hass.states[this._config.entity])return B`
                ...
                <div class="details-content">
                  <div class="meta-grid">
                    <div class="meta-item">
                      ...
                      <span class="meta-value">${ft(i.sentTs)}</span>
                    </div>
                    <div class="meta-item">
                      <span class="meta-label">Onset</span>
                      <span class="meta-value">${ft(i.onsetTs)}</span>
                    </div>
                    <div class="meta-item">
                      <span class="meta-label">Expires</span>
                      <span class="meta-value">${ft(i.endsTs)}</span>
                    </div>
                  </div>
    ...
    `}};bt.styles=mt,t([ht({attribute:!1})],bt.prototype,"hass",void 0),t([pt()],bt.prototype,"_config",void 0),t([pt()],bt.prototype,"_expandedAlerts",void 0),bt=t([lt("nws-alerts-card")],bt);const _t=window;_t.customCards=_t.customCards||[],_t.customCards.push({type:"nws-alerts-card",name:"NWS Alerts Card",description:"A card for displaying NWS weather alerts with severity indicators, progress bars, and expandable details."});export{bt as NwsAlertsCard};
